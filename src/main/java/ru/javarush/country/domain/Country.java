...
//    @GeneratedValue(strategy = GenerationType.AUTO)
    ...
    @Enumerated(EnumType.ORDINAL)   // Hibernate сохранит тип Continent в базу как числа
    ...
    @OneToMany(fetch = FetchType.EAGER) // принудительная загрузка связанных сущностей
