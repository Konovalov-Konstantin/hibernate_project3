...
import ru.javarush.country.dao.*;
import ru.javarush.country.domain.*;
import ru.javarush.country.redis.*;
...
public class Main {
    ...
    private List<City> getCities(Main main) {
        try (Session session = main.sessionFactory.getCurrentSession()) {
            ...
            Long totalCount = main.cityDAO.getCountOfCities();
            int step = 500;
    ...
    private List<CityCountry> transformData(List<City> cities) {
        return cities.stream().map(city -> {
            ...
            Set<Language> languages = countryLanguages.stream().map(cl -> {
                ...
                language.setLanguage(cl.getLanguauge());
    ...
    public static void main(String[] args) {
        Main main = new Main();
        List<City> cities = main.getCities(main);
